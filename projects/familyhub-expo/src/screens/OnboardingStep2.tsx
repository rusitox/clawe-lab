  ...
  return (
    <View style={styles.container}>
      <View style={styles.top}>
        ...
        <Text style={styles.subtitle}>Sumá a tu familia para organizar actividades y responsabilidades.</Text>

        <View style={styles.card}>
          <Text style={styles.cardTitle}>Ejemplo</Text>
          <Text style={styles.cardText}>Mamá · Papá · Hijos</Text>
        </View>
      </View>
